...
const Button: FC<CustomButtonProps> = ({
  ...
  const baseClassesCommon = `rounded-lg cursor-pointer whitespace-nowrap px-2  flex items-center duration-300 ease-in-out transform text-base ${disableBtn?"opacity-60 cursor-not-allowed":"cursor-pointer"} h-[${height}] w-[${width}]`
